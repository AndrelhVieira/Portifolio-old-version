const messages = {
  pt: {
    translations: {
      ...
      cover: {
        coverDescription: "Desenvolvedor Front End",
      },
      about: {
        title: "Sobre",
      ...
      curriculum: {
        ...
        professional: {
          office: {
            kenzie: "Peer Coach de programação",
            mannesoft: "Programador Trainee",
            db1: "Desenvolvedor React Júnior",
          },
          dates: {
            kenzie: "Janeiro 2021 - Julho 2021",
            mannesoft: "Agosto 2021 - Outubro 2021",
            db1: "Dezembro 2021 - Atualmente",
          },
          resume: {
            kenzie:
              "Revisando códigos e auxiliando na resolução de problemas de alunos com as tecnologias HTML5, CSS3, Javascript(ES6), ReactJS, Redux, GIT e outros.",
            mannesoft:
